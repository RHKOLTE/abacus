...
public class AbacusInterface {
	...
	public static final int MAX_CHAPTER_INDEXES = 8; // TODO remove later
	public static final int MAX_LESSON_INDEXES = 2; // TODO remove later
	...
	public static final String XML_FILE = "AbacusDemo.xml";
